      ...
      <View style={style.modalContent}>
        <View style={style.modalBody}>
          <View style={style.modalTitleContent}>
            <Text style={style.modalTitle}>{selectedItem ? selectedItem.title : "asd"}</Text>
          </View>
        ...
        <View style={style.choosenContent}>
          <TouchableOpacity onPress={() => handleUpdate(selectedItem)}>
            <View style={style.choosenItem}>
              <Text style={style.choosenItemText}>Düzenle</Text>
            </View>
          </TouchableOpacity>
          <TouchableOpacity onPress={handleDetail}>
            <View style={style.choosenItem}>
              <Text style={style.choosenItemText}>Rutininizi inceleyin</Text>
            </View>
          </TouchableOpacity>
          <TouchableOpacity onPress={() => handleDelete(selectedItem.id)}>
            <View style={style.choosenItem}>
              <Text style={style.choosenItemText}>Rutini sil</Text>
            </View>
          </TouchableOpacity>
        </View>
      </View>
